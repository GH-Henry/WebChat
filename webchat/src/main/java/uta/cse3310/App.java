...
public class App extends WebSocketServer
{
    ...
    public void onOpen(WebSocket conn, ClientHandshake handshake) {
        System.out.println(
            "Remote socket addr: " + conn.getRemoteSocketAddress() + "\n" +
            "RemoteSocketAddr.getAddress(): " + conn.getRemoteSocketAddress().getAddress() + "\n" +
            "Host address: " + conn.getRemoteSocketAddress().getAddress().getHostAddress() + " entered the room!");
